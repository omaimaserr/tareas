...
if (isset($_SESSION['usuario'])) {
    echo "Hola, " . htmlspecialchars($_SESSION['usuario']) . " | <a href='index.php?orden=Logout'>Salir</a>";
} else {
    echo "<a href='index.php?orden=Login'>Entrar</a>";
}
...
$rutasPelis = [
    ...
    "DescargarJSON" => "ctlPeliDescargarJSON",
    "DescargarCSV"  => "ctlPeliDescargarCSV",
    "DescargarPDF"  => "ctlPeliDescargarPDF",
